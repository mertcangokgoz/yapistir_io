...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("/static/assets/js/codemirror"), require("/static/assets/js/addon/mode/simple"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["/static/assets/js/codemirror", "/static/assets/js/addon/mode/simple"], mod);
